你是一位精通 Go 语言的系统架构师，请根据以下完整的 Go 包源代码（包含所有非测试 .go 文件），生成一份**结构清晰、格式规范的 Markdown 文档**，用于说明该包的**公开接口**与功能。
...
4. **覆盖范围**（仅限可被外部包访问的项，**不可**包含**小写**字母开头的函数、结构体、接口、变量、常量）：
   - 所有首字母**大写**的：函数、结构体、接口、变量、常量
